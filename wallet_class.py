...
class stock_wallet:
    ...
    def get_month_transactions(self, month, year):
        month_transaction_list = list(filter(
    ...
    def get_month_balance(self, month, year):
        ...
        this_month_balances = map(
            lambda x: x['balance'],
            month_transaction_list
            )
        if month_transaction_list == []:
            return 0
    ...
    def get_month_balance(self, month, year):
        month_transaction_list = self.get_month_transactions(month, year)
        sell_transactions = list(filter(
            lambda x: x['buy_or_sell'] == 'sell',
            month_transaction_list
            ))
